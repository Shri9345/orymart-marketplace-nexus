    ...
    try {
      ...
      if (success) {
        toast({
          ...
          description: "Welcome to OryMart",
        });
        navigate('/');
      }
    } catch (error) {
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 border">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button
              type="submit"
              className="w-full gradient-primary text-white py-2 px-4 rounded-lg font-medium hover:shadow-lg transition-all"
              disabled={isLoading}
            >
          ...
          <div className="mt-4 text-center">
            <p className="text-sm text-gray-600">
              Want to sell on OryMart?{' '}
              <Link to="/seller-register" className="font-medium text-purple-600 hover:text-purple-500">
                Become a seller
              </Link>
            </p>
          </div>
